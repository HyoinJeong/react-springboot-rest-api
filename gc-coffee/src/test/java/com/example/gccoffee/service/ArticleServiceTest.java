...
class ArticleServiceTest {
    ...
    void givenArticleId_whenSearchingArticle_thenReturnsArticle() {
        ...
        assertThat(dto)
                ...
                .hasFieldOrPropertyWithValue("type", article.getType());
    ...
    void givenModifiedArticleInfo_whenUpdatingArticle_thenUpdatesArticle() {
        ...
        assertThat(article)
                ...
                .hasFieldOrPropertyWithValue("type", dto.type());
    ...
    private ArticleDto createArticleDto(String title, String content, String type) {
