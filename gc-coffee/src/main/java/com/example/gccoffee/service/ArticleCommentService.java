...
import com.example.gccoffee.repository.ArticleCommentRepository;
import com.example.gccoffee.repository.ArticleRepository;
import com.example.gccoffee.repository.UserAccountRepository;
...
public class ArticleCommentService {
    ...
    public void saveArticleComment(ArticleCommentDto dto) {
        try {
            ...
            articleCommentRepository.save(dto.toEntity(article, userAccount));        } catch (EntityNotFoundException e) {
